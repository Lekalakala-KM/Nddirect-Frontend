...
const AboutSection = () => {
  return (
    <div className="bg-[#7f42ce] py-16 px-4 lg:px-0 mx-auto" id="about">
      <div className="max-w-6xl lg:flex justify-center items-center mx-auto gap-5 lg:pt-8">
        <img
          src={summary}
          alt=""
        ...
        <div className="px-4 flex flex-col items-center lg:items-start text-center lg:text-start">
          <div className="sectionHeadings">
            <h2 className="uppercase font-bold mb-4"><GoDash className="inline"/> About us</h2>
            <p className=" text-[#f0ede8] text-4xl font-bold capitalize mb-4 leading-[1.2] text-center lg:text-start lg:max-w-[400px]">
              What’s In Our DNA
            </p>
          </div>
...
We believe in empowering individuals and communities through opportunity, training, and mentorship—because when people grow, businesses thrive.
          ...
          <a
            href="tel:0671931316"
            className="flex items-center justify-center capitalize border-1 border-[#7f42ce] bg-[#ef9c33] hover:bg-[#f0ede8] transition-all duration-300 hover:text-[#7f42ce] text-[#f0ede8] font-light hover:font-normal py-2 px-8 rounded-full shadow-md transition-all duration-400 ease"
          >
